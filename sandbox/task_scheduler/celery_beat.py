...
if __name__ == "__main__":
    ...
    log.add("sandbox/task_scheduler/logs/celery_beat.log", retention=3, rotation="15 MB", level="DEBUG")
    log.add("sandbox/task_scheduler/logs/celery_beat_error.log", retention=3, rotation="15 MB", level="ERROR")
    ...
    try:
        start_celery.beat(app=celeryapp.app)
