...
def main():
    ...
    location: openmeteo_location_domain.LocationIn = api_openmeteo.client.search_location(location_name=api_openmeteo.location_name, results_limit=1, language="en")
