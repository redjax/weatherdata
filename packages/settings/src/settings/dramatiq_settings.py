...
def return_dramatiq_rabbitmq_url(
    username: str = DRAMATIQ_SETTINGS.get(
        "DRAMATIQ_RABBITMQ_USERNAME", default="guest"
    ),
    password: str | None = DRAMATIQ_SETTINGS.get(
        "DRAMATIQ_RABBITMQ_PASSWORD", default=""
    ),
    ...
    vhost: str | None = DRAMATIQ_SETTINGS.get(
        "DRAMATIQ_RABBITMQ_VHOST", default="rabbitmq"
    ),
) -> str:
...
def return_dramatiq_rabbitmq_credentials(
    username: str = DRAMATIQ_SETTINGS.get(
        "DRAMATIQ_RABBITMQ_USERNAME", default="guest"
    ),
